...
class _webSiteUnitsPageState extends State<webSiteUnitsPage> {
  ...
  bool hidePricesVarFromFireabse = false;
  ...
  Widget build(BuildContext context) {
    print(this.hidePrices.toString());
                ...
                children: [
                  ...
                  this.isLoading
                      ...
                      : Animate(
                          ...
                          child: Padding(
                            padding: staticVar.isItWebPlatform(context)
                                ? EdgeInsets.only(
                            ...
                            child: Row(
                              mainAxisAlignment:
                                  staticVar.isItWebPlatform(context)
                              ...
                              children: [
                                Container(
                                  ...
                                  width: staticVar.isItWebPlatform(context)
                                      ? staticVar.golobalWidth(context) * .6
                                      : staticVar.fullwidth(context) * .95,
                                    ...
                                    children: [
                                      ...
                                      ...this.boxes.map((e) {
                                        return uniteCustomerCard(
                                          ...
                                          imageUrl: findUnitById(
                                                  units: this.unitsType,
                                                  id: e["unitTypeID"] ??
                                                      "")?["image"] ??
                                              "404",
                                          unitName: e['unitTypeName'] ?? "404",
                                          description: findUnitById(
                                                  units: this.unitsType,
                                                  id: e["unitTypeID"] ??
                                                      "")?["sizeDescription"] ??
                                              "404",
                                          price:this.hidePrices ? "..." :   findUnitById(
                                                      units: this.unitsType,
                                                      id: e["unitTypeID"] ??
                                                          "")?["priceHistory"]
                                                  ?.last?["price"] ??
  ...
  Future<bool> options() async {
    try {
      ...
      DocumentSnapshot docSnapshot =
          await FirebaseFirestore.instance.collection('options').doc('1').get();

      // Check if the document exists
      if (docSnapshot.exists) {
        // Retrieve the value of the hidePrices field
        bool data = docSnapshot['hidePrices'];
        this.hidePricesVarFromFireabse = data;
        // print("this is the option fucntion and I'm and my resul is :  $hidePricesVarFromFireabse");
        // the hidePriceAlgo() function will make handel the hide/show prices logic .
        hidePriceAlgo();
        return hidePricesVarFromFireabse;
      } else {
